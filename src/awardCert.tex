...
\DTLloaddb{awardData}{src/inputData.csv}
...
%Seal Image%
\put(10,20){\color{shadecolor}\frame{\includegraphics[scale=0.5]{src/seal.png}}}

%Signature Image%
\put(145,50){\makebox(0,0){{\color{shadecolor}\frame{\includegraphics[scale=0.6]{src/Signature.png}}}}}
